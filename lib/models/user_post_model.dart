...
//
//     final userPostModel = userPostModelFromMap(jsonString);

import 'package:meta/meta.dart';
import 'dart:convert';

UserPostModel userPostModelFromMap(String str) => UserPostModel.fromMap(json.decode(str));

String userPostModelToMap(UserPostModel data) => json.encode(data.toMap());
...
class UserPostModel {
    ...
    factory UserPostModel.fromMap(Map<String, dynamic> json) => UserPostModel(

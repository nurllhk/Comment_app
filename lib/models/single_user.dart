...
SingleUserModel singleUserModelFromMap(String str) => SingleUserModel.fromMap(json.decode(str));

String singleUserModelToMap(SingleUserModel data) => json.encode(data.toMap());
